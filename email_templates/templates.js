exports.resetPassword = (user,token)=>{
    ...
    <div style="border:2px solid #262626;width:95%;margin:30px auto;padding:1rem">
        ...
        <br> 
        <a href="http://${process.env.FRONT}/#/nueva_clave/${token.token}">Reestablecer clave </a>
    </div>
    `
};
...
exports.firstValidation = (user,token)=>{
    ...
    <br>
    <a href="http://${process.env.FRONT}/#/confirmation/${token.token}">Validar Correo Electronico </a> `
